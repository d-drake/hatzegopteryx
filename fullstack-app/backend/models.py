from sqlalchemy import Column, Integer, String, DateTime, Boolean, Float, Index, ForeignKey, JSON, Text
...
class User(Base):
    ...
    approved_registrations = relationship("RegistrationRequest", back_populates="approved_by_user", foreign_keys="RegistrationRequest.approved_by")
...
class RegistrationRequest(Base):
    ...
    # Relationships
    approved_by_user = relationship("User", back_populates="approved_registrations", foreign_keys=[approved_by])
...
class BlacklistedToken(Base):
    ...
    expires_at = Column(DateTime(timezone=True), nullable=False)  # When the token would have expired naturally
