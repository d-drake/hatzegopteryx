...
export function SPCDataProvider<T extends SPCDataItem>({ 
  ...
  const value = useMemo(() => ({
    ...
    refetch,
    service
  }), [data, allEntityData, isLoading, error, filters, isInitialized, handleFiltersChange, clearFilters, refetch, service]);

  return React.createElement(context.Provider, { value }, children);
}

// Hook factory for using the context
export function createUseSPCData<T extends SPCDataItem>(context: React.Context<SPCDataContextValue<T> | null>) {
