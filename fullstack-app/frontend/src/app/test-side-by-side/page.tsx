        ...
        <div className="px-4 py-3">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <div>
              ...
              <span
                className={`text-sm font-semibold ${selectedWidth >= 1500 ? "text-green-600" : "text-blue-600"}`}
              >
        ...
        <div className="mt-8 max-w-4xl mx-auto">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>
                • <strong>Width {"<"} 1500px:</strong> Tabbed interface with
                Timeline/Variability tabs
              </li>
              <li>
                • <strong>Width ≥ 1500px:</strong> Side-by-side layout with both
                charts visible
              </li>
              <li>
                • <strong>Chart Split:</strong> Timeline gets ~55% width,
                Variability gets ~45% width
              </li>
              <li>
                • <strong>X-axis alignment:</strong> Both charts maintain equal
                x-axis widths
              </li>
              <li>
                • <strong>Zoom sync:</strong> Zooming on one chart updates both
