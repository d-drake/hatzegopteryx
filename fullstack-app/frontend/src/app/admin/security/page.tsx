    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Monitor security health and run vulnerability scans
        </p>
      </div>

      {/* Health Status */}
      <div
        className={`bg-${getHealthColor()}-50 border border-${getHealthColor()}-200 rounded-lg p-6 mb-8`}
      >
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-gray-600 mt-1">
              Last updated:{" "}
              {dashboard && new Date(dashboard.timestamp).toLocaleString()}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ul className="space-y-2">
            {dashboard?.recommendations.immediate
              .filter((r) => r)
              .map((rec, idx) => (
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ul className="space-y-2">
            {dashboard?.recommendations.scheduled
              .filter((r) => r)
              .map((rec, idx) => (
                <li key={idx} className="flex items-start">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-600 mt-1">
              Check for weak or old passwords
            </p>
          ...
          >
            ...
            {scanResults["privilege-escalation"] && (
              <div className="mt-2 text-sm text-green-600">
                Found {scanResults["privilege-escalation"].findings.length}{" "}
                alerts
              </div>
            )}
          </button>
