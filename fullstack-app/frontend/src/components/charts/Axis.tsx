...
export default function Axis({
  ...
  useEffect(() => {
    ...
    if (gridLines) {
      ...
      if (availableSpace > 0) {
        ...
        const estimatedLabelSize = isHorizontal
          ? isNarrowScreen
            ? 50
            : 100 // Width for date labels with responsive sizing
    ...
    if (gridLines) {
      ...
      axisGroup.select(".domain").style("stroke", "#64748b"); // slate-500 color
      axisGroup.selectAll(".tick line").style("stroke", "#64748b"); // slate-500 color
      axisGroup
        .selectAll(".tick text")
